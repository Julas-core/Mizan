...
import 'package:mobile/screens/decision_analysis_screen.dart';

void main() {
  group('DecisionAnalysisScreen Widget Tests', () {
    testWidgets('Displays Verdict and Primary Reason', (
      WidgetTester tester,
    ) async {
      ...
      expect(
        find.text('This fits comfortably within your plan.'),
        findsOneWidget,
      );
    ...
    testWidgets('Displays Behavior Banner when penalty triggers', (
      WidgetTester tester,
    ) async {
      final mockEvaluationData = {
        'id': 'test-123',
    ...
    testWidgets('Shows feedback prompt after action tap', (
      WidgetTester tester,
    ) async {
      final mockEvaluationData = {
        'id': 'test-123',
      ...
      await tester.tap(find.text('Buy item'));
      await tester.pumpAndSettle();

      expect(find.text('Was this recommendation helpful?'), findsOneWidget);
